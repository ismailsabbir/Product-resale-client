...
import "../PaymentTypesPages/PaymentTypesPages.css";
          ...
          <div className="col col-12 col-sm-12 col-md-12 col-lg-4">
            <div className="taka-payment-con">
              ...
              <div className="taka-payment">
                <p>
                  Subtotal ({paymentinfo?.quentity} Items and shipping fee
                  included)
                </p>
                <p>${paymentinfo.totaldoler}</p>
              </div>
              <div className="taka-payment">
                <p>Total Amount</p>
                <p className="totla-taka">$ {paymentinfo.totaldoler + 10}</p>
              </div>
            </div>
          </div>
        </div>
...
export default CartPaymentTypesPages;
